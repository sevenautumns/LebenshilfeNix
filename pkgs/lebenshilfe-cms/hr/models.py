...
class SalaryAgreement(models.Model):
    ...
    salary_tandem = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Tandem")
    salary_coordination = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Koordination")
    salary_management = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Geschäftsführung")
...
class Employee(Person):
    ...
    vocational_trainings = models.ManyToManyField(VocationalTraining, blank=True, verbose_name="Berufsbildungen")
...
class OtherEmployment(models.Model):
    employee = models.ForeignKey(Employee, on_delete=models.PROTECT, related_name='other_employments', verbose_name="Mitarbeiter:in")
    employer = models.CharField(max_length=255, blank=True, null=True, verbose_name="Arbeitgeber (Sonstige)")
    working_hours = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Stundenumfang")
...
class Applicant(Person):
    ...
    desired_hours = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True, verbose_name="Stundenwunsch")
    desired_school = models.ForeignKey('pedagogy.School', on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Schulwunsch")
    notice_period = models.CharField(max_length=255, blank=True, null=True, verbose_name="Kündigungsfristen")
    suitability_rating = models.CharField(max_length=255, blank=True, null=True, verbose_name="Einstufung nach Eignung")
...
class Absence(models.Model):
    ...
    employee = models.ForeignKey(Employee, on_delete=models.PROTECT, verbose_name="Mitarbeiter:in")
    ...
    reason = models.CharField(max_length=50, choices=REASON_CHOICES, verbose_name="Grund")
...
class TrainingRecord(models.Model):
    staff = models.ForeignKey(Employee, on_delete=models.PROTECT, verbose_name="Personalfall")
    training_type = models.ForeignKey(TrainingType, on_delete=models.PROTECT, verbose_name="Fortbildungstyp")
    valid_from = models.DateField(verbose_name="Gültig von")
