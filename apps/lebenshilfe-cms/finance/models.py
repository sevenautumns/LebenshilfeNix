...
class FeeAgreement(models.Model):
    ...
    price_tandem = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Tandem")
    price_coordination = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Koordination")
...
class PoolAgreement(models.Model):
    valid_from = models.DateField(verbose_name="Gültig von")
    valid_to = models.DateField(verbose_name="Gültig bis")
    installment = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Abschlag")
    payer = models.ForeignKey(CostPayer, on_delete=models.PROTECT, verbose_name="Kostenzahler")
...
class Payment(models.Model):
    supervision = models.ForeignKey('pedagogy.Supervision', on_delete=models.PROTECT, verbose_name="Betreuung")
    payer = models.ForeignKey(CostPayer, on_delete=models.PROTECT, verbose_name="Kostenzahler")
